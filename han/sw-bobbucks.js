...
self.addEventListener(PAYMENT_REQUEST_EVENT, async (e) => {
  ...
  let url = 'https://barathstalin6.github.io/summa/han/';
...
async function sendUpdateToMerchant() {
  ...
  const response = await currentPayment.paymentRequestEvent.changePaymentMethod('https://barathstalin6.github.io/summa/han/');
  postMessageToClient({
